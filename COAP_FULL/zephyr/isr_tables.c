...
struct _isr_table_entry __sw_isr_table _sw_isr_table[65] = {
	...
	{(const void *)0x38679, (ISR)0x482e7}, /* 42 */
	...
	{(const void *)0x384b9, (ISR)0x482e7}, /* 49 */
