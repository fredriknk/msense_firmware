...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SENSOR_SAMPLE_INTERVAL_SECONDS, 30);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_TEMP_ALERT_LIMIT, 24);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_COAP_FOTA_JOB_CHECK_RATE_MINUTES, 1800);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_COAP_FOTA_THREAD_STACK_SIZE, 2048);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_COAP_SHADOW, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_COAP_SHADOW_CHECK_RATE_SECONDS, 300);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_HEAP_MEM_POOL_SIZE, 100000);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_POSIX_ENV, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_COAP_EXTENDED_OPTIONS_LEN_VALUE, 64);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_COAP_CLIENT_STACK_SIZE, 6144);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_COAP_CLIENT_MAX_INSTANCES, 2);
