...
struct _isr_table_entry __sw_isr_table _sw_isr_table[65] = {
	...
	{(const void *)0x37ef1, (ISR)0x4796f}, /* 42 */
	...
	{(const void *)0x37d31, (ISR)0x4796f}, /* 49 */
